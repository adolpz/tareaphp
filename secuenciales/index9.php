...
$mensaje = "<div class='alert alert-warning' role='alert'> Datos procesados </div>";
 }
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <button type="submit" name="enviar" class="btn btn-warning">calcular</button>
        </form>
        <div class="jumbotron">
               ...
               <table class = "table table-hover ">
                ...
                <th>Nombre</th>
                <th>55% parciales.</th>
                <th>30% examen final.</th>
                <th>15% trabajo final.</th>
